  ...
  <div class="pokemon-infos">
    <div class="top">
      ...
      <div class="bottom-right">
        ...
        <div class="pokemons-infos__container">
          <div class="btns">
            <router-link v-if="pokemon.id === 1" :to="{ name: 'PokemonView', params: { id: pokemon.id - 1 } }"
            ...
            <router-link v-if="pokemon.id === 905" :to="{ name: 'PokemonView', params: { id: pokemon.id + 1 } }"
              style="visibility: hidden">
              <p>Next</p><span>►</span>
            </router-link>
